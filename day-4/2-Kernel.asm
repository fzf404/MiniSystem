...
%macro crtWin  6        ; 建立窗口,行数-颜色-左上角YX-右上角YX
...
subMenu:
    ...
    printStr cx, 16h, 6, 32     ; 16颜色Blue+Brown
    
    mov bp, menu_2
    mov cx, menu_3-menu_2
    printStr cx, 16h, 10, 32     ; 16颜色Blue+Brown

    mov bp, menu_3
    mov cx, menu_3-menu_2
    printStr cx, 16h, 14, 32     ; 16颜色Blue+Brown

    mov bp, menu_4
    mov cx, menu_4-menu_3
    printStr cx, 16h, 18, 32     ; 16颜色Blue+Brown

    ret

firstEnter:

    crtWin  0,3eh,1,0,23,79    ; 刷新窗口

    mov bp, tabInfo
    mov cx, menu_1-tabInfo
    printStr  cx,3eh,3,18

    crtWin 0,65h,6,32,6,42
    crtWin 0,65h,10,32,10,42
    crtWin 0,65h,14,32,14,42
    crtWin 0,65h,18,32,18,42

    call subMenu    ; 窗口中打印字符串

    setPos 0,6,32               ; 光标设置在第1个菜单处
...
mainWin:
    crtWin 0,3eh,0,0,24,79           ;定义窗口背景
    crtWin 0,1fh,0,0,0,79            ;第一行
    crtWin 0,1fh,24,0,24,79          ;最后一行
    ret
...
showTime:
    ...
    crtWin 0,1dh,24,60,24,79     ;设置窗口颜色
